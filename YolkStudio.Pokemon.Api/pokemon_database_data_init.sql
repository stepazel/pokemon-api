...
-- Insert Pokemon data
INSERT INTO "Pokemons" ("Id", "Name", "Level", "TypeId", "OwnerId", "Health", "CaughtAt") VALUES
-- Fire type Pokemon
...
--          JOIN "Pokemons" p ON pm."PokemonId" = p."Id"
...
SELECT COUNT(*) AS "Total Pokemon" FROM "Pokemons";
